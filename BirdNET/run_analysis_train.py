...
audio_dir_train = 'input/birdclef-2024-2/train_audio/'
...
final_results_path = os.path.join(output_dir, "final_results_train.csv")
...
for root, dirs, files in sorted(os.walk(audio_dir_train)):
    for file in sorted(files):
        ...
        # Generate embeddings
        embeddings_output_path = os.path.join(embedding_out_dir, os.path.splitext(file)[0] + '.embeddings_train.txt')
